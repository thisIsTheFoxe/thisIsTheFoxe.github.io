...
let jsonWords = {
	"n": ["gott", "alles", "frau", "morgen", "vater", "leute", "tag", "weg", "ordnung", "mädchen"],
	"art":["der", "den", "die", "das", "einwn", "eine", "einer", "dem"],
	"kon":["als","mit", "und", "aber", "weil", "wie","zu", "dass", "da", "wenn"],
	"pro":["meine", "mein","nicht", "kein", "keine", "jede", "jeder", "mir", "mich", "ich", "sie", "er", "du", "es", "wir", "ihr", "dich", "was","dir","sich", "uns", "ihn"],
	"prä":["um","zu", "auf", "aus", "hier", "für", "an", "von", "im"],
	"v": ["wird", "ist", "hat", "kann", "geht", "läuft", "rennt", "liegt", "sind", "war", "hasst", "kann", "wird", "macht", "will", "sieht", "sagt", "wartet", "tut", "trinkt", "isst", "gefällt", "läasst"],
	"adj":["gut", "schlecht", "schon", "sehr","einfach"]
}
...
function getNewWordWithSum(sum){
	...
	let possibleKeys = []
	switch(prevWord){
		case "n": possibleKeys.push("v", "kon", "prä")
		break;
		case "art": possibleKeys.push("n", "adj")
		break;
		case "kon": possibleKeys.push("n", "art", "adj")
		break;
		case "pro": possibleKeys.push("n", "adj")
		break;
		case "prä": possibleKeys.push("n", "art")
		break;
		case "v": possibleKeys.push("adj", "n", "pro", "prä", "kon")
		break;
	...
	while(cloneWord.sum() != sum){
		...
		for(var key in json){
			...
			if(key[0] == "-") regKey = regKey.replace("-","") + "\\b";
				...
				newWord = newWord.replace(regex, highest)
		}
		let arr = []
